...
if __name__ == '__main__':
    ...
    testxycsv = pd.read_csv(data_path + 'price_maxmin_x_test_10.csv', index_col=0, header=0)  # 把csv文件里的内容读出来
    prexycsv = pd.read_csv(data_path + 'price_maxmin_x_pre_10.csv', index_col=0, header=0)  # 把csv文件里的内容读出来
